...
年齢
<?php
    if($_POST['gender'] === '1') { echo '〜19歳'; }
    if($_POST['gender'] === '2') { echo '20歳〜29歳'; }
    if($_POST['gender'] === '3') { echo '30歳〜39歳'; }
    if($_POST['gender'] === '4') { echo '40歳〜49歳'; }
    if($_POST['gender'] === '5') { echo '50歳〜59歳'; }
    if($_POST['gender'] === '6') { echo '60歳〜'; }
?>
<br>
お問い合わせ内容
